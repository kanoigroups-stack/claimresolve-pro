        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="tel:+91XXXXXXXXXX" className="flex items-center gap-3 text-sm hover:text-white transition-colors"><Phone className="w-4 h-4 text-accent-500" />+91 XXXXXXXXXX</a>
