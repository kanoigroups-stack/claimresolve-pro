        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:help@tatkalclaims.com" className="flex items-center gap-3 text-sm hover:text-white transition-colors"><Mail className="w-4 h-4 text-accent-500" />help@tatkalclaims.com</a>
