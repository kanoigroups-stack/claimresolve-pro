...
const faqs = [
  ...
  { question: "What are your fees? Do I pay upfront?", answer: "We operate on a success-fee model. You pay nothing upfront. Our fee is 10-22% of the recovered amount (depending on resolution level), payable only after you receive your settlement. We also offer a free initial case evaluation." },
