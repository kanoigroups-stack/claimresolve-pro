...
const testimonials = [
  { name: "Rajesh Sharma", location: "Mumbai, Maharashtra", claimType: "Health Insurance Rejection", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face", rating: 5, text: "My mother's cancer claim was rejected citing a pre-existing condition. ClaimResolve Pro's team found a loophole in the insurer's reasoning and got us ₹8.5 lakhs within 3 months. Life-changing!" },
  { name: "Priya Nair", location: "Bangalore, Karnataka", claimType: "Motor Total Loss", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face", rating: 5, text: "After my car accident, the insurance offered only 60% of the value. These experts negotiated and I received 95% of the insured amount. Professional, responsive, and truly caring." },
  { name: "Amit Patel", location: "Ahmedabad, Gujarat", claimType: "Mis-sold ULIP Policy", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face", rating: 5, text: "I was sold a policy as a 'fixed deposit' by my bank. ClaimResolve helped me file a complaint with IRDAI and recover my entire premium of ₹5 lakhs plus interest. Highly recommended!" },
  { name: "Sunita Devi", location: "Delhi NCR", claimType: "Claim Delay - 8 Months", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face", rating: 4, text: "My home insurance claim was stuck for 8 months. Within 2 weeks of hiring ClaimResolve, the insurer released ₹12 lakhs. Their regulatory pressure approach works wonders." },
];
