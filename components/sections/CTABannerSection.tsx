        ...
        <div className="relative bg-gradient-to-r from-primary-800 via-primary-700 to-primary-800 rounded-3xl p-8 md:p-16 overflow-hidden text-center md:text-left">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 flex-shrink-0">
              ...
              <a href="tel:+91XXXXXXXXXX" className="inline-flex items-center justify-center px-6 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition-all border border-white/20"><Phone className="w-5 h-5 mr-2" />Call Experts</a>
            </div>
          </div>
        </div>
      </motion.div>
