        ...
        <div className="relative bg-gradient-to-r from-primary-800 via-primary-700 to-primary-800 rounded-3xl p-8 md:p-16 overflow-hidden text-center md:text-left">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 flex-shrink-0">
              <a href="#contact-form" className="btn-accent text-base px-8 py-4 group">Submit Your Case Now<ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" /></a>
