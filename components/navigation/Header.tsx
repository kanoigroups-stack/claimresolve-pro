        ...
        <div className="container-main px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="tel:+91XXXXXXXXXX" className="flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-primary-700 transition-colors">
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-4">
              ...
              <a href="tel:+91XXXXXXXXXX" className="flex items-center justify-center gap-2 text-primary-700 font-medium mt-2">
